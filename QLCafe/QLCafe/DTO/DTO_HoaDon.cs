...
namespace QLCafe.DTO
{
    public class DTO_HoaDon
    {
        ...
        {
            get { return tiengiamgia; }
            set { tiengiamgia = value; }
        }

        public DTO_HoaDon(int getid, DateTime getgiovao, DateTime getgiora, int getidban, int gettrangthai, float getTienGio, string getmahoadon, int getidnhanvien, float gettongtien, float getgiamgia, float getkhachcantra, float getkhachthanhtoan, float gettienthua, string getIDChiNhanh, int tiengiamgia)
        {
            this.ID = getid;
            this.GioRa = getgiora;
        ...
        public DTO_HoaDon(DataRow dr)
        {
            ...
            if (MaHD.ToString() != string.Empty)
                this.MaHoaDon = MaHD.ToString();
            var IDNV = dr["IDNhanVien"];
            if (IDNV.ToString() != string.Empty)
            ...
            this.Tiengiamgia = int.Parse(dr["TienGiamGia"].ToString());
        }
    }
}
